// FuzzyCMeansAdaptativo.cpp: implementation of the FuzzyCMeansAdaptativo class.
//
//////////////////////////////////////////////////////////////////////

#include "FuzzyCMeansAdaptativo.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

FuzzyCMeansAdaptativo::FuzzyCMeansAdaptativo()
{
...
FuzzyCMeansAdaptativo::FuzzyCMeansAdaptativo(Pattern *p,char *nDados,char *nSaida) : FuzzyCMeans(p,nDados,nSaida)
{
...
void FuzzyCMeansAdaptativo::representacao()
{
	/////////////////////////////
	//Estágio 1
...
void FuzzyCMeansAdaptativo::executarAplicacao()
{
...
//	saida<<setiosflags(ios::fixed);
	saida<<"Results: \n\n";
	saida<<setw(25)<<"Algorithm: "<<"Fuzzy C-Means Adaptativo";
		...
		for(iteracao=0;iteracao<limiteIteracao;iteracao++)
		{
			...
			if(iteracao)
			{
				if(fabs(Jatual-Janterior)<=epsilon)
				{
					...
					{
						cluster[l].desalocaWeightVector();
					}
...
void FuzzyCMeansAdaptativo::executarSimulacao()
{
	bool primeiroValor=true;
