// FuzzyCMeansNaoAdaptativo.cpp: implementation of the FuzzyCMeansNaoAdaptativo class.
//
//////////////////////////////////////////////////////////////////////

#include "FuzzyCMeansNaoAdaptativo.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

FuzzyCMeansNaoAdaptativo::FuzzyCMeansNaoAdaptativo()
{
...
FuzzyCMeansNaoAdaptativo::FuzzyCMeansNaoAdaptativo(Pattern *p,char *nDados,char *nSaida) : FuzzyCMeans(p,nDados,nSaida)
{
...
void FuzzyCMeansNaoAdaptativo::representacao()
{
...
void FuzzyCMeansNaoAdaptativo::executarSimulacao()
{
	/////////////
	//Inicialização unitária dos weightVectors
	double *weightVector=new double[numeroVariaveis];
	for(int j=0;j<numeroVariaveis;j++)
	{
		weightVector[j]=1.0;
	}
	...
	for(i=0;i<numeroInicializacoes;i++)
	{
		inicializacao();
...
void FuzzyCMeansNaoAdaptativo::executarAplicacao()
{
	/////////////
	//Inicialização unitária dos weightVectors
	double *weightVector=new double[numeroVariaveis];
